...
![Screenshot](public/screenshots/fig.png)

Ce projet offre une expérience de data storytelling interactive. Il permet d'explorer les données économiques mondiales à travers des graphiques dynamiques, des cartes interactives et une narration guidée.
